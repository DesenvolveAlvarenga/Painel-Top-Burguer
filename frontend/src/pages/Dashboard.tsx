    ...
    return `<!DOCTYPE html>
      ...
      <head>
        ...
        <style>
          ...
          .receipt h1 { font-size: 20px; margin: 0 0 2px; text-align: center; letter-spacing: 0.04em; font-weight: 700; }
          ...
          .print-section { margin-top: 2px; }
          .print-section strong { font-size: 13px; font-weight: 800; }
          .print-notes { font-size: 16px; margin-top: 0px; white-space: pre-wrap; font-weight: 700; line-height: 1.45; }
          .footer { text-align: center; margin-top: 2px; font-size: 13px; font-weight: 700; }
